package com.infinitum_micro_tech.free_ok__pro;
...
public class MainActivity extends Activity
    ...
    public final String buy_pro_url="https://play.google.com/store/apps/details?id=com.infinitum_micro_tech.free_ok__pro";
    private static final String PrivacyPolicyUrl="https://www.freeprivacypolicy.com/privacy/view/1c8f7590e2e57b21bf244ce5897e8ad3";

    private static final String main_url = "https://m.ok.ru";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //layouts
        Liner_web_view = (LinearLayout) findViewById(R.id.liner1);
    ...
    void LoadPage(String host, int port, String url) {
        ...
        com.infinitum_micro_tech.free_ok__pro.Proxy.setProxy(host,port,webView,getApplicationContext());
    ...
    public void BuyPro(View view) {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(buy_pro_url));
        this.startActivity(intent);
    }
